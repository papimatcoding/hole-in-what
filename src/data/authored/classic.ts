...
c6.popBumpers=[{x:220,y:700,r:34,triggerX:320,triggerY:775,triggerRadius:115}];
path(c6,pt(142,650),pt(398,432),pt(304,280),pt(108,166));
bait(c6,pt(320,775),pt(220,700),pt(142,650));
...
bait(c7,pt(210,790),pt(390,730),pt(420,548));

// 08 — Ramp introduction. The straight centre entry is bait; learn to enter the ramp from its left half.
...
c8.ramps=[{x:195,y:568,w:150,h:82,dx:0,dy:-1,lift:345,boost:34}];
...
bait(c10,pt(210,790),pt(360,690),pt(270,500),pt(142,440),pt(150,300),pt(352,258),pt(400,184));
