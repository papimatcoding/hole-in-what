...
c5.walls=[r(28,600,292,24),r(220,370,292,24)];
c5.bumpers=[{x:382,y:676,r:36}];
path(c5,pt(382,676),pt(430,548),pt(168,330),pt(422,166));
...
path(c6,pt(142,650),pt(398,432),pt(108,166));
...
// Sand application: the useful first line crosses the slow pocket, then a central screen forces a deliberate setup.
const c9=base("classic",9,pt(424,840),pt(106,154),3,4,"sand");
c9.sand=[r(138,520,224,100)];
c9.walls=[r(28,642,270,24),r(220,392,24,112),r(278,300,234,24)];
path(c9,pt(250,574),pt(180,500),pt(180,350),pt(390,254),pt(106,154));
