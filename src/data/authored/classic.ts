...
// Chapter exam: retain the proven three-stroke skeleton. A slightly larger bumper improves the
// intended contact window without reopening the two-shot bypass found by the first curve pass.
