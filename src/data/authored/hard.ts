...
const h1=base("troll",1,pt(126,832),pt(410,154),3,5,"wall");
...
const h2=base("troll",2,pt(420,832),pt(112,164),3,5,"bumper");
...
h3.walls=[r(246,282,26,430)];
h3.popVoids=[{x:300,y:450,w:190,h:170,triggerX:388,triggerY:678,triggerRadius:120}];
path(h3,pt(184,760),pt(180,520),pt(180,280));trap(h3,"safe-lane-collapse");

const h4=base("troll",4,pt(270,844),pt(270,142),4,6,"wall");
h4.walls=[r(28,650,322,24),r(190,414,322,24)];
h4.popWalls=[{x:28,y:294,w:318,h:24,triggerX:118,triggerY:486,triggerRadius:118}];
path(h4,pt(420,718),pt(420,520),pt(112,350),pt(410,250));trap(h4,"cross-gate");

const h5=base("troll",5,pt(96,842),pt(432,142),4,6,"bumper");
