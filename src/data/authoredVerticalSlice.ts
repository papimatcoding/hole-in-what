...
function c08():LevelDefinition{const l=base("classic",8,{x:420,y:820},{x:110,y:180},2,3,"wall");l.walls=[r(28,575,280,W),r(220,345,292,W)];return path(l,{x:410,y:525},{x:120,y:405},{x:120,y:250});}
function c09():LevelDefinition{const l=base("classic",9,{x:270,y:820},{x:270,y:170},2,3,"bumper");l.walls=[r(28,470,150,W),r(362,470,150,W),r(28,300,182,W),r(330,300,182,W)];l.bumpers=[{x:270,y:500,r:36}];return path(l,{x:270,y:500},{x:220,y:390},{x:270,y:250});}
...
// 11: mechanic-introduction breather. The direct attacking line deliberately crosses sand.
function c11():LevelDefinition{
  const l=base("classic",11,{x:105,y:820},{x:430,y:180},2,3,"sand");
  l.sand=[r(180,455,180,175)];
  l.walls=[r(28,340,190,W)];
  return path(l,{x:245,y:545},{x:360,y:360},{x:430,y:245});
}
...
// 15 introduces ice: safe 2-shot route, plus a very precise HIO mastery line if the player discovers it.
...
// A razor-thin HIO exists after learning the false safe lane, but 2 strokes is the intended mastery par.
function h03():LevelDefinition{
  const l=trap(base("troll",3,{x:270,y:820},{x:270,y:170},2,3,"wall"),"safe-lane-collapse");
