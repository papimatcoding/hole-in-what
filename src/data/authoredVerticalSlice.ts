...
function c05():LevelDefinition{const l=base("classic",5,{x:270,y:820},{x:270,y:170},2,3,"wall");l.walls=[r(198,430,144,W),r(198,566,144,W),r(198,430,W,160),r(318,430,W,160)];return path(l,{x:125,y:610},{x:125,y:350});}
...
function c08():LevelDefinition{const l=base("classic",8,{x:420,y:820},{x:110,y:180},2,3,"wall");l.walls=[r(28,575,325,W),r(185,345,327,W)];return path(l,{x:420,y:525},{x:120,y:410},{x:120,y:250});}
function c09():LevelDefinition{const l=base("classic",9,{x:270,y:820},{x:270,y:170},2,3,"bumper");l.walls=[r(28,470,150,W),r(362,470,150,W),r(28,300,210,W),r(302,300,210,W)];l.bumpers=[{x:270,y:500,r:38}];return path(l,{x:270,y:500},{x:220,y:390},{x:270,y:250});}
function c10():LevelDefinition{const l=base("classic",10,{x:115,y:820},{x:420,y:165},3,4,"wall");l.walls=[r(28,650,255,W),r(255,485,257,W),r(28,320,255,W)];return path(l,{x:410,y:705},{x:125,y:540},{x:410,y:375},{x:420,y:235});}
function c11():LevelDefinition{const l=base("classic",11,{x:105,y:820},{x:430,y:180},2,3,"sand");l.sand=[r(175,430,205,150)];l.walls=[r(28,365,125,W),r(387,365,125,W)];return path(l,{x:240,y:590},{x:350,y:410},{x:430,y:260});}
...
function h04():LevelDefinition{const l=trap(base("troll",4,{x:130,y:820},{x:385,y:175},2,3,"bumper"),"rebound-punish");l.triangles=[tri({x:160,y:440},{x:255,y:440},{x:160,y:345}),tri({x:380,y:315},{x:285,y:315},{x:380,y:410})];l.popBumpers=[{x:355,y:255,r:33,triggerX:320,triggerY:405,triggerRadius:110}];return path(l,{x:210,y:500},{x:315,y:365},{x:330,y:245},{x:385,y:205});}
