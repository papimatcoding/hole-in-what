...
**Block 1 is frozen. Audit 2.1 has passed full pre-release lab certification and is ready to become the standard development critic.**

1. Merge PR #1 (`feature/audit-2-human` → `dev`) and verify post-merge CI/Pages. No maintenance is required because campaign physics/geometry is unchanged.
